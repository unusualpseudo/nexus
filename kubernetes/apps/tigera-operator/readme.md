# Configuration prior to flux

Add flux missing annotations manualy to starting managing it by Helm
...
[Reference](https://github.com/onedr0p/flux-cluster-template/issues/321)
